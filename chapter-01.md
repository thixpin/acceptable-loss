...
သန်းခေါင်ယံသုံးနာရီဆိုတာ ကျွန်တော့်အတွက် နေ့လယ်ခင်းတစ်ခုနဲ့တူနေတာကြာပါပြီ။

ခန်းထဲမှာ လေအေးပေးစက်အဟောင်းရဲ့ တဂျီးဂျီးသံ လွှမ်းနေတယ်။ Compressor က တစ်ချက်တစ်ချက် တုန်ခါပြီး အသက်ခြောက်ဆယ်ကျော်အဘိုးအိုလို ချောင်းဆိုးတတ်တယ်။ အဲဒီအသံအောက်မှာ စားပွဲအောက်က workstation ပန်ကာက တိုးတိုးလေး ဝီဝီမြည်နေတယ်။ မော်နီတာ သုံးလုံး၊ keyboard နဲ့ ဘေးမှာ monitoring အတွက်ပဲ သီးသန့်ထားတဲ့ laptop တစ်လုံး ရှိတယ်။ Traffic ကို ကြည့်ဖို့ပဲ ချိတ်ထားတာ။ ရန်ကုန်အိပ်ခန်းလေးထဲက ကျွန်တော့် developer cockpit။
...
မီးလုံးကြီး ပျက်နေတာ လေးလ ရှိပြီ။ ပြင်ဖို့ အာရုံမရဘူးဆိုတာ တကယ်တော့ terminal ရှေ့က မခွာချင်တာ။ ကိုယ့်အိမ်မီးလုံးကိုတောင် လင်းအောင်မလုပ်နိုင်တဲ့ automation engineer က cloud provider သုံးခုမှာ production ကို hot-patch လုပ်ပေးနေရတယ်။

တံခါးဘေးမှာ helmet။ Visor ပေါ်က မနေ့ညက ဖုန်တွေ မသုတ်ရသေး။ ပြည်လမ်းမကြီးပေါ် apex corner ကနေ ကိုယ်ကိုကိုင်းချ၊ throttle ပြန်ဆွဲထုတ်လိုက်တဲ့ အရသာ ခုထိ အသားထဲ ကျန်နေသေးတယ်။ terminal ရှေ့ ကုပ်နေတဲ့ ကောင်တစ်ကောင်နဲ့ မဆိုင်ဘူးလို့ ထင်ကြမှာ။ ဒါပေမဲ့ နှစ်ခုစလုံးမှာ margin ကပဲ အသက်။ ဆိုင်ကယ်ပေါ် စင်တီမီတာ၊ server room မှာ millisecond။ ကွာတာက ဆိုင်ကယ်ပေါ် မှားရင် သေတယ်။ Server ပေါ် မှားရင် client ငွေကုန်ပြီး ကိုဇေယျာရဲ့ Slack မှာ အာမေဋိတ်အမှတ်တွေ တိုးလာရုံ။
...
Worker တစ်ခု `(plw4t)` ရဲ့ အလုပ်လုပ်နှုန်းက ကျန်နှစ်ခုထက် အရမ်း နိမ့်နေတယ်။ Junior engineer ဆိုရင် "restart ချလိုက်ပါ" ဆိုပြီး ပြောမှာ သေချာတယ်။ ဒါပေမဲ့ ဆယ်နှစ်ကျော် ဒီအလုပ်ထဲ ကျင်လည်ခဲ့ရင်း သင်ခန်းစာတစ်ခု ရခဲ့တယ်၊ "restart" ဆိုတာ ဆေးဝါး မဟုတ်ဘူး၊ မှတ်ဉာဏ်ပျောက် ဗုံးတစ်လုံးပဲ။ ပြဿနာကို ဖြေရှင်းတာ မဟုတ်ဘဲ၊ ပြဿနာ ဖြစ်ခဲ့ကြောင်း သက်သေအထောက်အထားတွေ အကုန် မီးရှို့ပစ်လိုက်တာနဲ့ အတူတူပဲ။
...
```bash
$ git log --oneline -5 -- deployment/inference-controller.py
...
```bash
$ kubectl exec -n inference vllm-worker-7f9b8c-plw4t -- sha256sum /app/inference_server.py
a7f92e8b4c1d... /app/inference_server.py

$ sha256sum ./local-copy/inference_server.py
a7f92e8b4c1d... ./local-copy/inference_server.py
```
...
8.8.8.8 ဆိုတာ Google ရဲ့ public DNS address ဖြစ်ပေမဲ့ ဒီ packet က port 443 ဆီသွားတာ။ IP ပိုင်ရှင်ကို သိရုံနဲ့ traffic ရဲ့ရည်ရွယ်ချက်ကို မသိနိုင်ဘူး။ အိမ်ထဲကလူတစ်ယောက် ညသန်းခေါင်မှာ ဖုန်းဆက်နေတာကို မြင်ရသလိုပဲ။ နံပါတ်တချို့ကို သိပေမယ့် ဟိုဘက်က ဘယ်သူကိုင်နေတာ၊ ဘာပြောနေလဲ မကြားရသေးဘူး။
...
Slack မှာ noti တက်လာတယ်။ ကြည့်လိုက်တော့ ကိုဇေယျာ။
...
လိမ်တာ မဟုတ်ဘူး latency က တည်ငြိမ်တယ်။ ဒါပေမဲ့ ဒါကို ဘယ်သူက ထိန်းပေးနေလဲဆိုတာပဲ ကျွန်တော့်ကို စိတ်ပူစေတာ။
...
kworker က system နောက်ကွယ်မှာ အလုပ်လုပ်တဲ့ ညဝန်ထမ်းလို။ ဒီကောင်ကတော့ kernel thread မဟုတ်ဘဲ executable ရှိတဲ့ userspace process။ နာမည်ကို ယူဝတ်ထားတာ။ ကိုယ့် script ရဲ့ socket မှတ်တမ်းနဲ့ တိုက်လိုက်တော့ ဒီ PID ကပဲ ငါးမိနစ်တစ်ခါ အပြင်ကို ဆက်သွယ်နေတာ တွေ့ရတယ်။ ဝန်ထမ်းယူနီဖောင်း မှန်ပေမဲ့ ဝန်ထမ်းကတ်က တခြားလူရဲ့ကတ်။
...
`connect` က အဲဒီလိပ်စာကို အတည်ပြုတယ်။ Collector ပေါ်က ကိုယ်ပိုင် TLS parser ကို capture ဖိုင်နဲ့ ဆက်စစ်လိုက်တယ်။
...
ကျွန်တော့်အခန်းရဲ့ ပျက်နေတဲ့ မီးလုံးကို ထပ်မော့ကြည့်မိတယ်။ အမှောင်ထဲ ထိုင်နေရတာကို ခုမှ ကောင်းကောင်း သတိထားမိတယ်။ Monitor သုံးလုံးရဲ့ အပြာရောင် ကလွဲရင်၊ ကျွန်တော့်ဘဝမှာ တခြား အလင်းဆိုတာ မကျန်တော့ဘူး။
